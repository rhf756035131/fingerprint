...
public class SearchDeviceActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int pos, long arg3) {
        ...
        dialog.setPositiveButton("connect",
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        BlueToothinfo.BlueToothAddress=msg.substring(msg.length()-17);

                        if(BlueToothinfo.lastblueToothAddress!=BlueToothinfo.BlueToothAddress){
        ...
        dialog.setNegativeButton("cancel",
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        BlueToothinfo.BlueToothAddress = null;
                    }
                });
        dialog.show();
    }
